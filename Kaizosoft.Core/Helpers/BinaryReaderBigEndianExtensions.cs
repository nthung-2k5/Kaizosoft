...
/// <summary>
/// Extension methods for BinaryReader to support big-endian reading operations.
/// </summary>
public static class BinaryReaderBigEndianExtensions
{
    extension(BinaryReader binaryReader)
    {
        public short ReadInt16BigEndian() =>
                BinaryPrimitives.ReadInt16BigEndian(
                    binaryReader.BaseStream is MemoryStream ms && ms.TryReadSpanUnsafe(2, out var readBytes)
                            ? readBytes
        ...
        public int ReadInt32BigEndian() =>
                BinaryPrimitives.ReadInt32BigEndian(
                    binaryReader.BaseStream is MemoryStream ms && ms.TryReadSpanUnsafe(4, out var readBytes)
                            ? readBytes
        ...
        public long ReadInt64BigEndian() =>
                BinaryPrimitives.ReadInt64BigEndian(
                    binaryReader.BaseStream is MemoryStream ms && ms.TryReadSpanUnsafe(8, out var readBytes)
                            ? readBytes
    ...
    private static bool TryReadSpanUnsafe(this MemoryStream memoryStream, int numBytes,
                                          out ReadOnlySpan<byte> readBytes)
    {
